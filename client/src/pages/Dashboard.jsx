...
const SAMPLE_STORIES = [
  {
    ...
    description:
      "Watched the sun melt into the Aegean Sea from a clifftop in Oia. The sky turned every shade of orange and pink — nothing I'd ever seen before. The locals were calm, the wine was cold, and time just... stopped.",
  ...
  },
  {
    ...
    description:
      "Pad Thai from a cart at 11pm, mango sticky rice at midnight, and tom yum soup for breakfast. Bangkok doesn't sleep and neither did I. Every corner had something new, spicy, and absolutely unforgettable.",
  ...
  },
  {
    ...
    description:
      "Day 7 of the Annapurna Circuit. My legs were done but my soul was full. Above the clouds, with only prayer flags and silence around me, I finally understood why people keep coming back to these mountains.",
    ...
    >
      ...
      <div className="flex items-start justify-between px-5 pt-5 pb-3">
        <div className="flex items-center gap-3">
          <div
            className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold text-white font-body ${getAvatarColor(authorName)}`}
          >
            {initials}
          </div>
          <div>
        ...
        {story.tags?.length > 0 && (
          <div className="flex flex-wrap gap-1.5 mt-3">
            {story.tags.map((tag) => (
              <span
                key={tag}
                className="font-body text-xs text-amber-400/70 bg-amber-400/8 border border-amber-400/15 rounded-full px-2.5 py-0.5"
              >
                #{tag}
              </span>
            ))}
        ...
        <aside className="col-span-3 hidden lg:block">
          ...
          >
            ...
            <div className="px-4 pb-4 -mt-6">
              ...
              <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#080b10] mb-2">
                {user?.profile_pic ? (
                  <img
                  ...
                  <div className="bg-amber-500 w-full h-full flex items-center justify-center text-white font-bold">
              ...
              <p className="font-body text-xs text-white/40 mt-0.5">
                {user?.bio || "Travel enthusiast · Explorer"}
              </p>

              <button
                onClick={() => navigate("/edit-profile")}
                className="mt-3 w-full bg-amber-500 text-black text-xs py-1 rounded-lg hover:bg-amber-400"
              >
                Edit Profile
              </button>
          ...
          >
            <p className="font-body text-xs text-white/30 uppercase tracking-wider mb-3">
              Explore
            </p>
            {[
              "🌏 Asia",
          ...
          >
            ...
            {[
              ...
              >
                <span className="font-body text-sm text-amber-400/70">
                  {tag}
                </span>
          ...
          >
            {["feed", "my stories"].map((tab) => (
              <button
                ...
                onClick={() => {
                  if (tab === "my stories") {
                    navigate("/my-stories"); // 👈 go to MyStories page
                  } else {
                    setActiveTab(tab);
                  }
                }}
            ...
            {[
              ...
              >
                <div className="flex items-center gap-2.5">
                  <div
                    className={`w-8 h-8 rounded-full ${person.color} flex items-center justify-center text-xs font-bold text-white`}
                  >
                    {person.init}
                  </div>
                  <div>
